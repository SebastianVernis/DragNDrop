    ...
    initializeRules() {
        return [
            ...
            },
            {
                ...
                wcag: '1.3.1',
                check: (element) => {
                    const inputs = element.querySelectorAll('input:not([type="hidden"]):not([type="submit"]):not([type="button"]), textarea, select');
                    const issues = [];
            ...
            },
            {
                ...
                check: (element) => {
                    ...
                    const issues = [];
                    const textElements = element.querySelectorAll('p, span, a, button, h1, h2, h3, h4, h5, h6, li, td, th');
